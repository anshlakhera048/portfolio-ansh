...
const ThemeToggle = () => {
  ...
  return (
    <motion.button
      ...
      style={{
        background: isDark ? "rgba(97,194,162,0.18)" : "rgba(97,194,162,0.25)",
        border: `1px solid ${isDark ? "rgba(97,194,162,0.3)" : "rgba(97,194,162,0.5)"}`,
      }}
      whileTap={{ scale: 0.93 }}
    ...
    >
      ...
      >
        {isDark ? (
          /* Moon icon */
          <svg className="w-3 h-3" fill="#8be9c7" viewBox="0 0 20 20">
            <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
          </svg>
        ) : (
          /* Sun icon */
          <svg className="w-3 h-3" fill="#e6a900" viewBox="0 0 20 20">
